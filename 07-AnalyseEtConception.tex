...
Gestion des signatures}  & \\
    ...
    \cline{1-7}
    US35&Visualisation des statistiques&En tant qu'utilisateur, je veux pouvoir visualiser les statistiques de l'application afin de suivre l'évolution de l'application.&Moyenne&2&&\multirow{4}{2cm}{\textbf{Sprint 7 :}Consultation des statistique}&\\
