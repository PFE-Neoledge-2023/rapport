...
Gestion des signatures}  & \\
    ...
    \cline{1-6}
    US4 & Visualisation de signature & En tant qu'utilisateur, je veux visualiser ma signature numérique, pour m'assurer qu'elle est correcte. & Moyenne & 2 &  du 1 à 2 Mars &  &\\
    ...
    US26&Gestion des préférences d'affichage&En tant qu'utilisateur, je veux gérer mes préférences d'affichage de l'application la couleur du thème  afin de personnaliser l'expérience utilisateur.&Moyenne&2&19 Avril&\multirow{5}{2cm}{\textbf{Sprint 6 : }Gestion du Profile, d'absence et de délégué}&\\
