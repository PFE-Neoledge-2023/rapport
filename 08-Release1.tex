...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      \multirow{3}{*}{1} & En tant qu'utilisateur d'Elise mobile, je veux
      ...
      \multirow{3}{*}{2} & En tant qu'utilisateur d'Elise mobile, je veux télécharger un fichier, afin d'avoir une copie locale du fichier sur mon appareil. & 2.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      & & 2.2 & Développer une fonction qui permet de télécharger un fichier. & \\
      \cline{1-5}

      \multirow{3}{*}{2} & En tant qu'utilisateur, je souhaite signer des fichiers avec image, Je veux être en mesure de sélectionner une signature pré-enregistrée parmi celles que j'ai créées précédemment, en utilisant simplement un système de glisser déposer pour l'appliquer au document à signer.& 2.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      & & 2.2 & Développer l'interface pour afficher la liste des signatures. & \\
      & & 2.3 & Développer une fonction qui permet d'afficher la liste des signatures. & \\
      & & 2.4 & Développer une fonction qui permet de signer par glisser et déposer une image dans un fichier. & \\
      \cline{1-5}

      \multirow{3}{*}{3} & En tant qu’utilisateur, je souhaite signer des fichiers a main. Je veux signer le document directement en utilisant une méthode de signature manuscrite, en dessinant ma signature. & 3.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      & & 3.2 & Développer une fonction qui permet de signer à main un fichier. & \\
      \cline{1-5}

      \multirow{3}{*}{4} & En tant qu'utilisateur, je souhaite déplacer les signatures non enregistrées, afin de les positionner correctement.& 4.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      & & 4.2 & Développer une fonction qui permet de modifier la position d'une signature d'un fichier. & \\
      \cline{1-5}

      \multirow{3}{*}{5} & En tant qu'utilisateur, je souhaite supprimer les signatures non enregistrées, afin d'annuler la signature.& 5.1 & Préparer l'interface sur figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      & & 5.2 & Développer l'interface de suppression d'une signature. & \\
      & & 5.3 & Développer une fonction qui permet de supprimer une signature d'un fichier. & \\
      \cline{1-5}

      \multirow{3}{*}{6} & En tant qu'utilisateur, je souhaite confirmer ou annuler la signature, afin de la valider ou de la supprimer.& 6.1 & Préparer l'interface sur figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      & & 6.2 & Développer l'interface de confirmation ou annulation de la signature. & \\
      & & 6.3 & Développer une fonction qui permet de confirmer ou annuler la signature d'un fichier. & \\
      \cline{1-5}
