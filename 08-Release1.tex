...
L'objectif de ce sprint est de préparer l'environnement de travail et d'étudier la solution ainsi que les technologies à utiliser afin de pouvoir commencer le développement de l'application, et ensuite, demarrer le développement de la première version de l'application contenant les fonctionnalités de base (S'authentifier, Se déconnecter).
...
\begin{adjustwidth}{-1cm}{}
  ...
  \hline
  6 & En tant qu'utilisateur, je veux déconnecter de l'application Elise Mobile afin de protéger mes informations et données personnelles. La déconnexion doit être facile d'accès et rapide &  6.1 &Préparer les interfaces sur Figma.&\multirow{3}{2cm}{2 Jours}\\
  \cline{3-4}
...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      \cline{1-5}
      \multirow{2}{*}{4} & En tant qu'utilisateur, je veux supprimer une signature que j'ai créée, afin de ne pas utiliser une signature
      ...
      \cline{1-5}
      \multirow{2}{*}{5} & En tant qu'utilisateur, je veux visualiser une signature que j'ai créée, pour m'assurer qu'elle est correcte. & 5.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      ...
      \cline{1-5}
      \multirow{2}{*}{6} & En tant que développeur, je veux développer un lecteur de fichier afin de l'utiliser pour la lecture des fichiers d'Elise Mobile. & 6.1 & Se familiariser avec pdf.js. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{design_signatures1}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{design_signatures2}
...
Ces captures d'écran, représente l'interface de création d'une signature par un utilisateur
\begin{figure}[H]
  \centering
...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      \multirow{3}{*}{1} & En tant qu'utilisateur, je veux rechercher des documents en utilisant différents critères, afin de trouver rapidement les documents dont j'ai besoin. & 1.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      ...
      \multirow{3}{*}{3} & En tant qu'utilisateur, je veux afficher mes documents favoris, afin de trouver rapidement les documents dont j'ai besoin.  & 3.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      ...
      \multirow{3}{*}{5} & En tant qu'utilisateur, je veux télécharger les fichiers attachés à un document, afin de garder une copie locale.. & 5.1 & Développer l'interface de téléchargement des fichiers. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
...
\end{figure}
\begin{itemize}
  \item \textbf{JEST} : Jest est un framework de test JavaScript créé par Facebook. Il est utilisé pour tester des applications JavaScript, notamment React, Vue.js, Angular et NodeJS.
...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      \cline{3-4}
      & & 1.3 & Ajouter la fonctionnalité de zoom dans neo-pdf-viewer. & \\
      \cline{3-4}
      & & 1.4 & Prendre en charge les fichiers de type image. & \\
      \cline{1-5}
      ...
      \multirow{3}{*}{5} & En tant qu'utilisateur, je souhaite déplacer les signatures non confirmées, afin de les positionner correctement.& 5.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
      & & 5.2 & Développer une fonction qui permet de modifier la position d'une signature d'un fichier. & \\
      \cline{1-5}

      \multirow{3}{*}{6} & En tant qu'utilisateur, je souhaite supprimer les signatures non confirmées, afin d'annuler la signature.& 6.1 & Préparer l'interface sur figma. & \multirow{3}{*}{2 Jour} \\
      \cline{3-4}
...
\begin{enumerate}
  ...
  \item [4.2] Le système affiche un message d'erreur.
  % second alternative
  \item [4.1] La fichier a des signatures non confirmées.
