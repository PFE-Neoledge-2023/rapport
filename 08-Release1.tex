\chapter*{Chapitre 3: Release 1}
\addcontentsline{toc}{chapter}{Chapitre 3: Release 1}
\markboth{Chapitre 3: Release 1}{Chapitre 3: Release 1}
\label{chap:release1}
\setcounter{part}{0}
...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \cline{1-5}
    \multirow{7}{*}{3} & \multirow{7}{6cm}{En tant que membre de l'équipe scrum, je souhaite installer et configurer l'environnement de développement.} &  3.1 &Installer VS code.&\multirow{7}{2cm}{0.5 Jour}\\
    \cline{3-4}
    ...
    5.1 &Initialiser un projet Ionic Vue.&\multirow{3}{2cm}{2 Jours}\\
    \cline{3-4}
  ...
  \hline
  \multirow{3}{*}{6} & En tant qu'utilisateur, je veux me déconnecter de l'application Elise Mobile afin de protéger mes informations et données personnelles. La déconnexion doit être facile d'accès et rapide. &  6.1 &Préparer les interfaces sur Figma.&\multirow{3}{2cm}{1 Jour}\\
  \cline{3-4}
...
\subsubsubsection{Diagramme de cas d'utilisation du sprint 1}
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{use_case_documents_sprint_1}}
...
\subsubsubsection{Description textuelle de cas d'utilisation « S'authentifier »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Se déconnecter »}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.85\textwidth]{design_auth}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/authentification/simple_login/simple_login}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.4\textwidth]{out/diagrams/authentification/logout/logout}}
...
\subsubsubsection{Diagramme de classe d'analyse de sprint 1 }


\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{dca_sprint1}}
...
\subsubsubsection{Diagramme de classe de conception de sprint 1}
La figure \ref{fig:class_diagram_auth} représente le diagramme de classe de conception du sprint 1.

% add image
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth]{dcc_sprint1}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/authentification/sequence_simple_login/sequence_simple_login}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/authentification/sequence_logout/sequence_logout}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth, height=0.7\textheight,keepaspectratio=true]{realision_auth}}
...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      \cline{1-5}
      \multirow{3}{*}{3} & En tant qu'utilisateur, je veux modifier le nom, la description et si elle est par défaut d'une signature que j'ai créée auparavant, afin de la mettre à jour ou de la rendre plus facile à identifier. & 3.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      ...
      obsolète ou inexacte.} & 4.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{1.5 Jour} \\
      \cline{3-4}
      & & 4.2 & Développer l'interface de suppression des signatures. & \\
      \cline{3-4}
      & & 4.3 & Développer la fonction qui permet de supprimer une signature. & \\
      \cline{1-5}
      \multirow{2}{*}{5} & \multirow{3}{6cm}{En tant qu'utilisateur, je veux visualiser une signature que j'ai créée, pour m'assurer qu'elle est correcte.} & 5.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      ...
      \cline{1-5}
      \multirow{3}{*}{6} & \multirow{3}{6cm}{En tant que développeur, je veux développer un lecteur de fichier afin de l'utiliser pour la lecture des fichiers d'Elise Mobile.} & 6.1 & Se familiariser avec pdf.js. & \multirow{3}{*}{7 Jours} \\
      \cline{3-4}
...
\subsubsubsection{Diagramme de cas d'utilisation du sprint 2 : « Gestion des signatures »}

% add image
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{use_case_signature_sprint_2}}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Créer une signature »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Afficher les signatures »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Modifier une signature »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Supprimer une signature »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Visualiser une signature »}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{design_signatures1}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.4\textwidth]{design_signatures2}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{out/diagrams/signatures/create/create_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{out/diagrams/signatures/delete/delete_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/signatures/view/view_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/signatures/update/update_signature}}
...
\subsubsubsection{Diagramme de classe d'analyse de sprint 2 }

\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{dca_sprint2}}
...
\subsubsubsection{Diagramme de classe de conception de sprint 2 : « Gestion des signatures »}

% add image
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{dcc_spint2}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/signatures/sequence_create/sequence_create_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/signatures/sequence_view/sequence_view_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/signatures/sequence_delete/sequence_delete_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/signatures/sequence_update/sequence_update_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{realisation_signatures1}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{realisation_signatures2}}
...
\subsubsubsection{Architecture du package}\\
...
\subsubsubsection{Développement des fonctionnalités }\\
...
\subsubsubsection{Publication du package}\\
...
\begin{figure}
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{neo_pdf_npm}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{rendering_pdf_viewer}}
...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      \multirow{3}{*}{1} & \multirow{3}{6cm}{En tant qu'utilisateur, je veux rechercher des documents en utilisant différents critères, afin de trouver rapidement les documents dont j'ai besoin.} & 1.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      ...
      2 & En tant qu'utilisateur, je veux rechercher un document en scannant son code QR, afin de le trouver rapidement. & 2.1 & Développer une fonction qui permet de rechercher un document à l'aide d'un code QR. & 2 Jours \\
      \cline{1-5}
      % Consulter la liste des documents en favoris
      \multirow{3}{*}{3} & \multirow{3}{6cm}{En tant qu'utilisateur, je veux afficher mes documents favoris, afin de trouver rapidement les documents dont j'ai besoin.}  & 3.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      ...
      \multirow{4}{*}{4} & En tant qu'utilisateur, je veux récupérer les informations relatives à un document, telles que la date de création et les tâches associées, afin de mieux comprendre son contexte, les modifier ou de les signer. & 4.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      ...
      \multirow{2}{*}{5} & \multirow{2}{6cm}{En tant qu'utilisateur, je veux télécharger les fichiers attachés à un document, afin de garder une copie locale.} & 5.1 & Développer l'interface de téléchargement des fichiers. & \multirow{2}{*}{1 Jour} \\
      \cline{3-4}
      ...
      \multirow{3}{*}{6} & \multirow{3}{6cm}{En tant qu'utilisateur, je veux consulter la liste des fichiers attachés à un document, afin de les visualiser.} & 6.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      ...
      \multirow{3}{*}{7} & En tant qu'utilisateur, je veux ajouter un fichier à un document, afin de le partager avec les autres utilisateurs. & 7.1 & Développer l'interface d'ajout des fichiers. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      & & 7.2 & Développer une fonction qui permet ajouter un fichier à un document. & \\
      \cline{1-5}
      % Scanner un fichier
      \multirow{3}{*}{8} & \multirow{3}{6cm}{En tant qu'utilisateur, je veux scanner un fichier à l'aide de la caméra de mon appareil, afin de le joindre à un document.} & 8.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      ...
      \multirow{3}{*}{9} & \multirow{3}{6cm}{En tant qu'utilisateur, je veux consulter la liste des tâches associées à un document, afin de suivre l'état d'avancement des tâches et de savoir qui est responsable de chaque tâche.} & 9.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{2 Jours} \\
      \cline{3-4}
      ...
      \multirow{3}{*}{10} & \multirow{3}{6cm}{En tant qu'utilisateur, je veux demander une tâche dans un document en assignant une personne responsable, afin de faciliter la collaboration et le suivi des tâches.} & 10.1 & Préparer l'interface sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      ...
      \multirow{3}{*}{11} & \multirow{3}{6cm}{En tant qu'utilisateur, je veux transferer une tâche dans un document a un autre utilisateur, afin que ce dernier puisse la prendre en charge.} & 11.1 & Préparer l'interface sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
      ...
      \multirow{3}{*}{12} &\multirow{3}{6cm}{En tant qu'utilisateur, je veux terminer une tâche dans un document, afin de clôturer la tâche et de faciliter le suivi du projet.} & 12.1 & Préparer les interfaces sur Figma. & \multirow{3}{*}{1 Jour} \\
      \cline{3-4}
...
\subsubsubsection{Diagramme de cas d'utilisation du sprint 3 : « Gestion des documents »}

% add image
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{use_case_documents_sprint_3}}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Accéder à un document »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Télécharger un document »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « consulter la liste des fichiers d'un document »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « ajouter un fichier à un document »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Scanner un fichier »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « consulter la liste des tâches d'un document »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Demander une tâche »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Tranférer une tâche »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Traiter une tâche »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Consulter la liste des documents en favoris  »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Chercher des documents »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Recherche a l'aide de code QR »}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{design_show_documents}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{design_content}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{design_task_managment}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{out/diagrams/documents/preview/preview_document}}
  \caption{Diagramme de séquence de cas d'utilisation « Accéder à un document  »}
  \label{fig:sequence_Accederaundocument}
\end{figure}
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{out/diagrams/documents/download/download}}
  \caption{Diagramme de séquence de cas d'utilisation « Télécharger un document  »}
  \label{fig:sequence_telechargerundocument}
\end{figure}
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{out/diagrams/documents/previewFiles/preview_files_document}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{out/diagrams/documents/previewTasks/preview_tasks_document}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.4\textwidth]{out/diagrams/documents/transfer_task/transfer_task}}
  \caption{Diagramme de séquence de cas d'utilisation « Transferer une tâche  »}
  \label{fig:sequence_transfer_task}
\end{figure}
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.4\textwidth]{out/diagrams/documents/traiter_task/traiter_task}}
  \caption{Diagramme de séquence de cas d'utilisation « Traiter une tâche  »}
  \label{fig:sequence_traiter_task}
\end{figure}
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/documents/add_file/add_file}}
  \caption{Diagramme de séquence de cas d'utilisation « Ajoutez un fichier à un document  »}
  \label{fig:sequence_add_file}
\end{figure}
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[height=0.9\textheight]{out/diagrams/documents/add_scan_file/add_scan_file}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.85\textwidth]{out/diagrams/documents/favoris/favorit_document}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.85\textwidth]{out/diagrams/documents/chercher/charcher_document}}
  \caption{Diagramme de séquence de cas d'utilisation « Chercher des documents  »}
  \label{fig:sequence_charcher_document}
\end{figure}
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/documents/scan_qr/scan_qr}}
...
\subsubsubsection{Diagramme de classe d'analyse de sprint "3" }
La figure \ref{fig:class_analyse_signatures3} représente le diagramme de classe d'analyse de sprint 3.
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{dca_sprint3}}
...
Après la présentation des diagrammes d'analyse, nous avons présenté dans cette partie les diagrammes de conception de sprint 3.
\newpage 
\begin{landscape}

\subsubsubsection{Diagramme de classe de conception de sprint 3 : « Gestion des documents »}

\begin{figure}[H]
  \centering
  \fbox{\includegraphics[height=0.8\textheight]{dcc_spint3}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/documents/sequence_preview/sequence_preview}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/documents/sequence_preview_files/sequence_preview_files}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/documents/sequence_preview_tasks/sequence_preview_tasks}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/documents/sequence_favoris/sequence_favoris}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/documents/sequence_transfer_task/sequence_transfer_task}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/documents/sequence_traiter_task/sequence_traiter_task}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/documents/sequence_add_file/sequence_add_file}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/documents/sequence_chercher/sequence_chercher}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{realisation_documents1}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{realisation_documents2}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{realisation_documents3}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{realisation_documents4}}
...
\subsubsubsection{Test unitaire} \\
...
\subsubsubsection{Cycle de développement du test unitaire}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.3\textwidth]{diagramme_test}}
  \caption{Cycle de développement du test unitaire}
  \label{fig:cyclededveloppementdutestunitaire}
\end{figure}

\subsubsubsection{Planification des tests unitaires}
...
\subsubsubsection{Exécution des tests unitaires}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{capture_test_success_sprint_3}}
...
\subsubsubsection{Diagramme de cas d'utilisation du sprint 4 « Visualisation et signature d'un fichier »}
% add image
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{use_case_documents_sprint_4}}
...
Dans les tableaux suivants, nous avons présenté les descriptions textuelles de ces cas d'utilisation.
\subsubsubsection{Description textuelle de cas d'utilisation « Visualiser un fichier  »}
\begin{longtable}{|p{5cm}|p{10cm}|}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Télécharger un fichier »}
\begin{longtable}{|p{5cm}|p{10cm}|}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Signer par glisser et déposer une image dans un fichier »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Signer à main un fichier »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Modifier la position d'une signature d'un fichier »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Supprimer une signature d'un fichier  »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Confirmer ou annuler les changements d'un fichier »}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{design_file}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{out/diagrams/sprint4/view_file/view_file}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/sprint4/download_file/download_file}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/sprint4/sign_by_image/sign_by_image}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/sprint4/sign_by_hand/sign_by_hand}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/sprint4/move_signature/move_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.65\textwidth]{out/diagrams/sprint4/delete_signature/delete_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.65\textwidth]{out/diagrams/sprint4/save_cancel_siganture/save_cancel_siganture}}
...
\subsubsubsection{Diagramme de classe d'analyse de sprint "4" }
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{dca_sprint4}}
...
\subsubsubsection{Diagramme de classe de conception de sprint 4 « Visualisation et signature d'un fichier »}

\begin{figure}[H]
  \centering
  \fbox{\includegraphics[height=0.8\textheight]{dcc_spint4}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/sprint4/sequence_view_file/sequence_view_file}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/sprint4/sequence_download_file/sequence_download_file}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/sprint4/sequence_sign_by_image/sequence_sign_by_image}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/sprint4/sequence_sign_by_hand/sequence_sign_by_hand}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/sprint4/sequence_move_signature/sequence_move_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/sprint4/sequence_delete_signature/sequence_delete_signature}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth]{out/diagrams/sprint4/sequence_save_cancel_siganture/sequence_save_cancel_siganture}}
...
\begin{figure}[H]
  ...
  \centering
  \fbox{\includegraphics[width=0.5\linewidth]{prendre_en_charge_image}}
  \caption{Capture de la prise en charge de l'affichage d'une image.}
  \label{fig:prendre_en_charge_image}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.4\textwidth}
  \centering
  \fbox{\includegraphics[width=0.5\linewidth]{zoom}}
