...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      \textbf{ID} & \textbf{User story} & \textbf{ID}  & \textbf{Tâche} & \textbf{Durée} \\
      \hline
      \multirow{2}{*}{1} & En tant qu'utilisateur, je veux accéder à la page des paramètres afin de personnaliser mon interface et pouvoir accéder a mon profile.
      ...
      \cline{1-5}
      \multirow{3}{*}{6} & En tant qu'utilisateur, je veux visualiser mes informations personnelles tels que les services et les licences que je possède pour vérifier leur exactitude et leur actualisation & 6.1 & Préparer l'interface de profile sur Figma & \multirow{3}{*}{2.5 Jour} \\
      \cline{3-4}
      & & 6.2 & Développer l'interface de profile & \\
      \cline{3-4}
...
\subsection{Implémentation du Sprint 9}
\textbf{•	Diagramme de cas d'utilisation du sprint 9}
...
\begin{figure}[H]
  ...
  \caption{Realisation de l'interface de modification de profile et gestion d'absence}
  \label{fig:RealisationInterfaceModificationProfile}
\end{figure}
