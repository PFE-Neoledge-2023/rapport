\chapter*{Chapitre 4: Release 2}
\addcontentsline{toc}{chapter}{Chapitre 4: Release 2}
\markboth{Chapitre 4: Release 2}{Chapitre 4: Release 2}
\label{chap:release2}
\setcounter{part}{0}
...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      & 1.1 & Étudier les spécifications techniques d'OIDC pour comprendre comment les implémenter dans notre application mobile. & \multirow{3}{*}{4 Jours} \\
      \cline{1-5}
      \multirow{1}{*}{2} & En tant qu'utilisateur, je veux me connecter à l'application Elise Mobile a l'aide d'un compte OIDC. & 2.1 & Développer la fonction qui permet de connecter. &  \multirow{1}{*}{2.5 Jours} \\
      \cline{1-5}
      ...
      \cline{1-5}
      \multirow{2}{*}{4} & \multirow{2}{6cm}{En tant qu'utilisateur, je veux sécuriser les actions sensibles de l'application Elise Mobile en utilisant la vérification biométrique (empreinte digitale, reconnaissance faciale).} & 4.1.& Développer la fonctionnalité d'authentification biométrique pour l'empreinte digitale et la reconnaissance faciale. & \multirow{2}{*}{7 Jours} \\
      \cline{3-4}
...
\subsubsubsection{Diagramme de cas d'utilisation du sprint 5}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Connexion à l'aide du protocole OIDC  »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Vérification biométrique  »}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.45\textwidth]{design_OIDC}}
...
\subsubsubsection{Diagramme de classe d'analyse de sprint 5 }
...
\subsubsubsection{Diagramme de classe de conception de sprint 5}
% add image
\begin{figure}[H]
  \centering
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/sprint5/sequence_Logout/sequence_Logout}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{out/diagrams/sprint5/sequence_verification_biometrique/sequence_verification_biometrique}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth, height=0.7\textheight,keepaspectratio=true]{realisation_OIDC}}
...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      & 1.1 & Préparer l'interface de paramètres sur Figma. & \multirow{3}{*}{2.5 Jours} \\
      \cline{3-4}
      & & 1.2 & Développer l'interface de paramètres	. & \\
      \cline{1-5}
      \multirow{2}{*}{2} & En tant qu'utilisateur, je veux gérer mes préférences d'aﬀichage de l'application la couleur du thème afin de personnaliser mon application.&2.1&Intégrer la fonctionnalité de mettre à jour les préférences d'affichage de l'utilisateur dans l'application &  \multirow{3}{*}{2 Jours} \\
      \cline{1-5}
      \multirow{1}{*}{3} & En tant qu'utilisateur, je souhaite pouvoir choisir la langue de l'application afin de personnaliser mon expérience utilisateur et que l'application se mette automatiquement à jour pour afficher tous les éléments dans la langue sélectionnée. & 3.1 &Intégrer la fonctionnalité de choix de la langue de l'application. & \multirow{1}{*}{2.5 Jours} \\
      \cline{1-5}
      ...
      \cline{1-5}
      \multirow{1}{*}{5} & En tant qu'utilisateur, je souhaite pouvoir chercher et sélectionner les espaces de travail afin de consulter les différents documents de chaque espace de travail & 5.1 & Développer la fonction qui permet de récupérer et sélectionner des espaces de travail & \multirow{1}{*}{1 Jour} \\
      \cline{1-5}
      \multirow{3}{*}{6} & En tant qu'utilisateur, je veux visualiser mes informations personnelles tels que les services et les licences que je possède pour vérifier leur exactitude et leur actualisation & 6.1 & Préparer l'interface de profil sur Figma & \multirow{3}{*}{0.5 Jour} \\
      \cline{3-4}
      & & 6.2 & Développer l'interface de profil & \\
      \cline{3-4}
      & & 6.3 & Développer la fonction qui permet de récupérer les données & \\
      \cline{1-5}
      \multirow{1}{*}{7} & En tant qu'utilisateur, je veux modifier ma photo de profil pour qu'elle reflète mieux mon image professionnelle ou personnelle actuelle.& 7.1 & Développer la fonction qui permet de modifier mon avatar. & \multirow{1}{*}{1 Jour} \\
      \cline{1-5}
      \multirow{3}{*}{8} & En tant qu'utilisateur, je veux déclarer une absence en spécifiant la date de début et la date de fin de mon absence, afin d'informer mes collègues et mes supérieurs hiérarchiques.& 8.1 & Préparer l'interface de gestion d'absence sur Figma & \multirow{3}{*}{2 Jours} \\
      \cline{3-4}
...
\subsubsubsection{Diagramme de cas d'utilisation du sprint 6}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Consulter la page de paramétre  »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Gérer les préférences d'affichage   »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Modifier la langue »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Vider le cache »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « chercher et sélectionner un espace de travail  »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Visualiser les informations personnelles  »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Modifier la photo de profil  »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Déclarer une absence   »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Annuler une absence    »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Chercher et affecter un délégué     »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Annuler une Délégation      »}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint6/consult_settings_page/consult_settings_page}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint6/preferance_affichage/preferance_affichage}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint6/change_language/change_language}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint6/clear_cache/clear_cache}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint6/lister_selectionner_workspaces/lister_selectionner_workspaces}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint6/visualiser_profil/visualiser_profil}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint6/annuler_absence/annuler_absence}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint6/search_affect_delegation/search_affect_delegation}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint6/annulation_delegation/annulation_delegation}}
...
\subsubsubsection{Diagramme de classe d'analyse de sprint 6 }
...
\subsubsubsection{Diagramme de classe de conception de sprint 6}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/sprint6/sequence_consult_settings_page/sequence_consult_settings_page}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/sprint6/sequence_preferance_affichage/sequence_preferance_affichage}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1.1\textwidth]{out/diagrams/sprint6/sequence_change_language/sequence_change_language}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1.1\textwidth]{out/diagrams/sprint6/sequence_clear_cache/sequence_clear_cache}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.815\textwidth]{out/diagrams/sprint6/sequence_lister_selectionner_workspaces/sequence_lister_selectionner_workspaces}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.815\textwidth]{out/diagrams/sprint6/sequence_visualiser_profil/sequence_visualiser_profil}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8  \textwidth]{out/diagrams/sprint6/sequence_edit_profil_avatar/sequence_edit_profil_avatar}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=\textwidth]{out/diagrams/sprint6/sequence_declare_absence/sequence_declare_absence}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth]{out/diagrams/sprint6/sequence_annuler_absence/sequence_annuler_absence}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth]{out/diagrams/sprint6/sequence_search_affect_delegation/sequence_search_affect_delegation}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth]{out/diagrams/sprint6/sequence_annulation_delegation/sequence_annulation_delegation}}
...
\begin{adjustwidth}{-1cm}{}
  % \usepackage{longtable}
    ...
    \begin{longtable}{|c|p{6cm}|c|p{6cm}|c|}
      ...
      & 1.1 & Préparer les interfaces sur Figma. & \multirow{5}{*}{5 Jours} \\
      \cline{3-4}
      ...
      \cline{1-5}
      \multirow{2}{*}{3} & \multirow{2}{6cm}{En tant qu'utilisateur, je veux consulter les documents a l'aide de filtre rapide afin de trouver les documents que je cherche.} & 3.1.& Ajouter la fonction de filtre a l'interface de consultation des statistiques. & \multirow{2}{*}{1.5 Jours} \\
      \cline{3-4}
      & & 3.2 & Développer la fonction qui permet de filtrer les documents par statistique. & \\
      \cline{1-5}
      \multirow{2}{*}{4} & \multirow{2}{6cm}{En tant qu'utilisateur, je veux refraichir les données de l'application afin de voir les dernières informations.} & 4.1.& Ajouter l'interface de rafraichissement des données a chaque page possible. & \multirow{2}{*}{7 Jours} \\
      \cline{3-4}
...
\subsubsubsection{Diagramme de cas d'utilisation du sprint 7}
\begin{figure}[H]
  \centering
...
\subsubsubsection{Description textuelle de cas d'utilisation « Consulter les statistiques »}
...
\subsubsubsection{Description textuelle de cas d'utilisation «Basculer entre les espaces de travail »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Consulter les documents a l'aide de filtre rapide »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Refraichissement
des données »}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/sprint7/view_stats/view_stats}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/sprint7/switch_workspace/switch_workspace}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/sprint7/docs_quick_filter/docs_quick_filter}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.65\textwidth]{out/diagrams/sprint7/refresh_data/refresh_data}}
...
\subsubsubsection{Diagramme de classe d'analyse de sprint 7 }
...
\subsubsubsection{Diagramme de classe de conception de sprint 7}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/sprint7/sequence_switch_workspace/sequence_switch_workspace}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{out/diagrams/sprint7/sequence_docs_quick_filter/sequence_docs_quick_filter}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth, height=0.7\textheight,keepaspectratio=true]{realisation_sprint7}}
...
\subsubsubsection{Diagramme de cas d'utilisation du sprint 8}
\begin{figure}[H]
  \centering
...
\subsubsubsection{Description textuelle de cas d'utilisation « Activer les notifications »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Désactiver les notifications »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Consulter les notifications »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Envoyer une notification »}
...
\subsubsubsection{Description textuelle de cas d'utilisation « Supprimer les notifications »}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/sprint8/activate_notification/activate_notification}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint8/deactivate_notification/deactivate_notification}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint8/lister_notification/lister_notification}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.55\textwidth]{out/diagrams/sprint8/send_notification/send_notification}}
...
\subsubsubsection{Diagramme de classe d'analyse de sprint 8 }
...
\subsubsubsection{Diagramme de classe de conception de sprint 8}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/sprint8/sequence_activate_notification/sequence_activate_notification}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/sprint8/sequence_deactivate_notification/sequence_deactivate_notification}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{out/diagrams/sprint8/sequence_lister_notification/sequence_lister_notification}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=1\textwidth, height=1\textheight,keepaspectratio=true]{realisation_sprint8}}
